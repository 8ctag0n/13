        ...
        <div class="wizard-card tui-box fade-in">
          ...
          <div class="info-box mb-6">
            <div class="text-sm">
              ...
              Download the <span class="text-cyan">zyb</span> CLI and run:
            </div>
          </div>

          <div class="code-block mb-6">
            <div class="text-mono text-cyan">
              $ zyb fhe encrypt -p ./my-job -v 42
            </div>
            <button class="btn-copy text-mono text-sm" on:click={() => navigator.clipboard.writeText('zyb fhe encrypt -p ./my-job -v 42')}>
              [COPY]
            </button>
          </div>
