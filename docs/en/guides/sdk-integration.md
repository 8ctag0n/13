...
```toml
[dependencies]
cypherlink-sdk = { git = "https://github.com/yourusername/zyberlink", branch = "main" }
cypherlink-types = { git = "https://github.com/yourusername/zyberlink", branch = "main" }
solana-sdk = "1.18"
solana-client = "1.18"
anyhow = "1.0"
...
```rust
use cypherlink_crypto::fhe::{encrypt_value, FheClient};
