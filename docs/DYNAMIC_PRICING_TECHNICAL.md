...
│         (/programs/cypherlink/src/processor/)                   │
│                                                                  │
...
**Location:** `/programs/cypherlink/src/processor/create_job.rs` (lines 97-144)
...
**Location:** `/programs/cypherlink/tests/dynamic_pricing_tests.rs`
