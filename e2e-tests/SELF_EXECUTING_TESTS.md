...
use cypherlink_types::JobAccount;
...
ProgramTest::new(
    "cypherlink",
    program_id,
    processor!(cypherlink::entrypoint::process_instruction),
)
```
...
El programa no está cargado. Verificar que `cypherlink` está en dependencias del Cargo.toml.
